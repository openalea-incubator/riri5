...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/openalea/riri5",
...
htmlhelp_basename = "riri5_documentation"
...
man_pages = [(master_doc, "openalea.riri5", "riri5 Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "riri5",
        "A simplified model of radiative transfer based on RATP",
        "Miscellaneous",
    ),
]
